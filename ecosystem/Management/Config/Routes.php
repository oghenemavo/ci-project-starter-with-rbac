...
$routes->group(
    ...
    function($routes) {
		...
		$routes->group('permissions', function($routes) {
			$routes->get('view/(:num)', 'PermissionSettings::viewPermission/$1', ['as' => 'view_permissions']); // done
			$routes->post('create/(:num)', 'PermissionSettings::createPermission/$1', ['as' => 'create_permission']); // done
			$routes->get('edit/(:num)', 'PermissionSettings::editPermission/$1', ['as' => 'edit_permission']); // done
			$routes->post('process/edit/(:num)', 'PermissionSettings::processEditPermission/$1', ['as' => 'process_edit_permission']); // done
		});
